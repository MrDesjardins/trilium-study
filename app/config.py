...
class Settings(BaseSettings):
    ...
    daily_new_cards: int = Field(default=10, alias="DAILY_NEW_CARDS")
    learn_ahead_minutes: int = Field(default=20, alias="LEARN_AHEAD_MINUTES")
    desired_retention: float = Field(default=0.9, alias="DESIRED_RETENTION")
    fsrs_enable_fuzzing: bool = Field(default=True, alias="FSRS_ENABLE_FUZZING")
